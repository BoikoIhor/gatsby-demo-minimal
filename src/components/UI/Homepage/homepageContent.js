...
const HomepageContent = (props) => {
    ...
    const popularProductsSku = popularProductSliderData.node.slides?.map((slide) => slide.title);
    ...
    return (
        <div className="homepage__content">
            <TreatmentCategorySlider sliderData={treatmentCategorySliderData.node}/>
            <RoundImageBanner bannerData={FAQSliderData.node}/>
            <TreatmentsSlider sliderData={ourTreatmentSliderData.node}/>
            <QuoteSlider sliderData={bottomSliderData.node}/>
            <DoctorsHelpBanner bannerData={doctorsHelpBanner.node}/>
            <ProductSlider
                title={popularProductSliderData.node.sliderTitle}
                isHomepage
                products={popularProduct}
            />
            <BlogSlider isHomepage sliderData={blogSliderData.node}/>
