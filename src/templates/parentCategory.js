...
const Category = (props) => {
    ...
    const { categoryId, title, allBigCommerceCategories, allBigCommerceBrands } = pageContext;
                ...
                <div className="homepage__content category-page__content">
                    ...
                    {categoryProducts.length ? (
                        <ProductSlider
                            ...
                            subtitle={'Iedereen is anders, wij zorgen voor de juiste behandeling.'}
